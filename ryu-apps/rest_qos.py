...
class QoS(object):
    ...
    def _get_cookie(self, vlan_id):
        ...
        for vlan_id in vlan_ids:
            ...
            cookie = (vlan_id << COOKIE_SHIFT_VLANID) + \
                self.vlan_list[vlan_id] + QOS_COOKIE_OFFSET
            #======
    ...
    def _cookie_to_qosid(cookie):
        #NOTE yjyao
        return (cookie - QOS_COOKIE_OFFSET) & ofproto_v1_3_parser.UINT32_MAX
        #====
