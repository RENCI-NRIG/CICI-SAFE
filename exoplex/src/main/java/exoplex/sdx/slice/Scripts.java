...
public class Scripts {
  ...
  public static String installOVS() {
    return "sudo apt-get install -y -qq openvswitch-switch;";
  }
  ...
  public static String installTraceRoute() {
    return "sudo apt-get install -y -qq traceroute;";
  }

  public static String installQuagga() {
    return "sudo apt-get install -y -qq quagga;";
  }

  public static String installIperf() {
    return "sudo apt-get install -y -qq iperf;";
  }

  public static String installVsftpd() {
    return "sudo apt-get install -y -qq vsftpd;";
  }
