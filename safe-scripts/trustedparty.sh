...
curl  -v -X POST http://$SAFESERVER_TRUSTED:7777/postIPAllocate -H "Content-Type: application/json" -d "{ \"principal\": \"rpkiroot\", \"otherValues\": [\"KXwvxF_rWupThUEAKwmkMTuhV8X-hqZXOAtMkWBFapc\",\"10.32.98.1/16\"] }"
