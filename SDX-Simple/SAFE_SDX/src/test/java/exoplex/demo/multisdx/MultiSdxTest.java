      ...
      Thread t = new Thread() {
        ...
        public void run() {
          try {
            ...
            Thread.sleep(5000);
            Method waitTillAllOvsConnected = sdxManager.getClass().getDeclaredMethod
              ("waitTillAllOvsConnected", null);
            waitTillAllOvsConnected.setAccessible(true);
            waitTillAllOvsConnected.invoke(sdxManager);
