 ...
 * DB write query
 */
public class ReadMessage extends QueryMessage
{
    ...
    public ReadMessage(String id, QueryOptions options)
    {
        super(getQuery(id), options);
    }
    
    private static String getQuery(String id) {
    	StringBuilder sb = new StringBuilder("SELECT * from " + DB + " where id='");
        sb.append(id).append("';");
        return sb.toString();
    }
