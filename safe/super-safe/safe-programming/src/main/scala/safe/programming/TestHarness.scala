...
//    val attestationBench = new AttestationBench(concurrency, jvmmapFile, slangManager)
...
//    geniBench.run()
    ...
    val namingBench = new NamingBench(concurrency, jvmmapFile, slangManager)
    namingBench.benchNameTreeParsing()
