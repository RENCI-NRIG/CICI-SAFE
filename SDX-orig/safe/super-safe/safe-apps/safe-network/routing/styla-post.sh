...
curl  -v -X POST http://152.3.136.36:7777/postAdvertise -H "Content-Type: application/json" -d "{ \"principal\": \"eZz9xWGKCwBdf8VjRtuSXYfaO1jLgjwOfrX8N3s14f8\", \"otherValues\": [\"ipv4\\\"152.3.1.1/24\\\"\",\"[eZz9xWGKCwBdf8VjRtuSXYfaO1jLgjwOfrX8N3s14f8,GA6A1fkLhsWUB7SKaPSCw8DO_ozLVM-Q8l0NdsqwRiA]\",\"iCqAs3PcsfGWjF3Ywcr47-0Jfd15Z7EQ3v6sSVza8KY\",\"[GA6A1fkLhsWUB7SKaPSCw8DO_ozLVM-Q8l0NdsqwRiA]\"] }"
