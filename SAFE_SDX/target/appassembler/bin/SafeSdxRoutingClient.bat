...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="SafeSdxRoutingClient" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" safe.sdx.RoutingClient %CMD_LINE_ARGS%
